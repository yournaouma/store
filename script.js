        ...
        li.innerHTML = `
          <div class="card" style="min-width:210px;max-width:220px;margin:0 auto;box-shadow: 0 4px 8px rgba(0,0,0,0.05);border-radius:8px;overflow:hidden;transition:transform 0.2s;">
            ...
            <div class="card-body" style="padding:12px;text-align:center;">
              ...
              <button class="btn-buy" onclick="window.location.href='${prod.link}'" data-tippy-content="اذهب الي متجر" style="background-color:#f39c12;color:#fff;border:none;padding:8px 15px;border-radius:5px;cursor:pointer;margin-top:10px;transition:background-color 0.2s;">أضف إلى السلة</button>
            </div>
          </div>
        `;
